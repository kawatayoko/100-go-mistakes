...
20250717 P51の関数オプションパターンのところを読むまで完了。次回は関数オプションパターンの実装。
20250724 P51 関数オプションパターンの実装まで完了。次回は2.12
20250801 P64 3.1の部分まで完了。次は3.2から。
20250816 P69 3.5まで完了。次は3.6から。
20250827 P88 3.9まで完了。次は3.10から。
20250903 P96 3.11まで完了。次は3.12から。バケット知らなかった。。。
20250910 P104 3章完了。次は4章から。
20251008 P114 4.3まで読んだ。次は4.3は実際にコードを書いて動かしてみる。
20251022 P127 次5.2から。